...
for k,v in fun.diction().items():
    ...
    #buy contract
    browser.implicitly_wait(10)
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[1]/div[3]/span[2]/input').send_keys('0.2')
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[1]/div[4]/span[2]/input').send_keys('0.1')
