...
for k,v in fun.diction().items():
    ...
    # buy contract
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[1]/div[3]/span[2]/input').send_keys('2.2')
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[1]/div[4]/span[2]/input').send_keys('3.3')
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[1]/div[6]/a').click()
    print 'purchase L3 successfully'
    #to wallet
    browser.find_element_by_xpath('//*[@id="navbar-collapse"]/ul[1]/li[3]/a').click()