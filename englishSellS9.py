...
for k,v in fun.diction().items():
    ...
    #sell contract
    browser.implicitly_wait(10)
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[2]/div[3]/span[2]/input').send_keys('100')
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[2]/div[4]/span[2]/input').send_keys('0.5')
    browser.find_element_by_xpath('/html/body/div/div[2]/div[2]/div[3]/div[1]/div[2]/div[6]/a').click()

    # to earnings
    browser.find_element_by_xpath('/html/body/div/div[1]/div/ul/li[3]/a').click()