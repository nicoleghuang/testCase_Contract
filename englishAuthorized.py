...
#login
browser.find_element_by_xpath('//*[@id="signin-form"]/div[2]/div/div[2]/div/input').send_keys('13250791512')
browser.find_element_by_xpath('//*[@id="signin-form"]/div[3]/div/input[2]').send_keys('123456')
time.sleep(15)
...
#swith to authorized account
browser.find_element_by_xpath('//*[@id="navbar-collapse"]/ul[2]/li[1]/a').click()
browser.find_element_by_xpath('//*[@id="navbar-collapse"]/ul[2]/li[1]/ul/li[2]/a').click()
browser.implicitly_wait(5)
browser.find_element_by_xpath('//*[@id="navbar-collapse"]/ul[2]/li[1]/ul/li[2]/ul/li[1]/a').click()
